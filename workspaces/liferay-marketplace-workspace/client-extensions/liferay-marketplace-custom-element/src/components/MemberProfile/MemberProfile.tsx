...
import {MemberProps, UserAccountProps} from '../../pages/PublishedAppsDashboardPage/PublishedDashboardPageUtil';
...
interface MemberProfileProps {
  userLogged?: UserAccountProps;
	member: MemberProps;
	setSelectedMember: (value: MemberProps | undefined) => void;
}

export function MemberProfile({ userLogged ,member, setSelectedMember}: MemberProfileProps) {
	const [{gravatarAPI}, _] = useAppContext();

  const publisherAdmin = "Publisher admin"

  const userPublishAdmin = userLogged?.roleBriefs?.some(role => role.name === publisherAdmin);
	...
	return (
      ...
      <div className='member-profile-content-header'>
        ...
        {!userPublishAdmin ? (
          <div className="member-profile-resend-invitation">
            <button className="member-profile-button-resend-invitation" onClick={() => console.log("aq")}>
              Resend invitation
            ...
            <button className="member-profile-button-edit-member" onClick={() => console.log("aq")}>
              <span className="member-profile-button-edit-member-label-edit">Edit</span> 
      ...
      <div className="member-profile-row">
        <DetailedCard cardIcon={userIcon} cardIconAltText="Member Card Icon" cardTitle="Profile">
        ...
        <DetailedCard cardIcon={shieldCheckIcon} cardIconAltText="Member Roles Icon" cardTitle="Roles">
